...
komengrup = []
listgrup = []
vulnot = '\x1b[31mNot Vulnerblity'
vuln = '\x1b[32mVulnerbility'
...
def menu():
    ...
    try:
        ...
        os.system('clear')
        print '\x1b[1;91m[!] No Token Is Result [!]'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    else:
    ...
    print '\x1b[1;37;40m| 1. Informasi Pengguna'
    print '\x1b[1;37;40m| 2. Hack Akun Facebook'
    print '\x1b[1;37;40m| 3. Bot               '
    print '\x1b[1;37;40m| 4. Lainnya....       '
    print '\x1b[1;37;40m| 5. Log Out           '
